...
- **Mediapipe / TensorFlow / Scikit-learn** – for gesture recognition (depending on implementation).  
- **PyAutoGUI / OS libraries** – for executing system-level commands.  
...
---
💡 *This project is a practical demonstration of vision-based gesture command recognition, bridging computer vision and human-computer interaction to create a seamless, touch-free computing experience.*
